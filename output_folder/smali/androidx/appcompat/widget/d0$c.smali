...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/d0$c$a;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/d0$c$a;->a(Landroid/content/res/Configuration;)I
    ...
    iput v1, p0, Landroidx/appcompat/widget/d0$c;->t:I

    iput v0, p0, Landroidx/appcompat/widget/d0$c;->u:I

    goto :goto_0

    :cond_0
    iput v0, p0, Landroidx/appcompat/widget/d0$c;->t:I

    iput v1, p0, Landroidx/appcompat/widget/d0$c;->u:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/d0$c;->v:Landroidx/appcompat/widget/c0;
    ...
    :goto_1
    iget-object v2, p0, Landroidx/appcompat/widget/d0$c;->w:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/d0$c;->v:Landroidx/appcompat/widget/c0;

    invoke-interface {v3, v0, v2}, Landroidx/appcompat/widget/c0;->f(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v1, p0, Landroidx/appcompat/widget/d0$c;->w:Landroid/view/MenuItem;

    if-eqz v1, :cond_3

    iget-object v2, p0, Landroidx/appcompat/widget/d0$c;->v:Landroidx/appcompat/widget/c0;

    invoke-interface {v2, v0, v1}, Landroidx/appcompat/widget/c0;->c(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroidx/appcompat/widget/d0$c;->t:I
    ...
    iget v0, p0, Landroidx/appcompat/widget/d0$c;->u:I
...
.method public setHoverListener(Landroidx/appcompat/widget/c0;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/d0$c;->v:Landroidx/appcompat/widget/c0;
