...
.field private g:Landroidx/appcompat/widget/e0$f;
...
.method private a(Ljava/lang/String;Landroidx/appcompat/widget/e0$e;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/e0;->b:Landroidx/collection/h;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/e0;->b:Landroidx/collection/h;
...
.method private declared-synchronized b(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/collection/e;->h(JLjava/lang/Object;)V
    :try_end_0
...
.method private d(Landroid/content/Context;)V
    ...
    sget v0, Li/d;->abc_vector_test:I
...
.method private f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/e0$f;->c(Landroidx/appcompat/widget/e0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private declared-synchronized i(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Landroidx/collection/e;->i(J)V
    :try_end_2
...
.method public static declared-synchronized l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/e0$c;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/e0$c;->d(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static p(Landroidx/appcompat/widget/e0;)V
    ...
    invoke-direct {p0, v1, v0}, Landroidx/appcompat/widget/e0;->a(Ljava/lang/String;Landroidx/appcompat/widget/e0$e;)V
...
.method private r(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/e0;->c:Landroidx/collection/i;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/e0;->b:Landroidx/collection/h;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/e0;->c:Landroidx/collection/i;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/e0;->c:Landroidx/collection/i;

    invoke-virtual {v8, p2, v3}, Landroidx/collection/i;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/e0;->b:Landroidx/collection/h;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/e0;->c:Landroidx/collection/i;
...
.method declared-synchronized m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/e0$f;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method o(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/e0$f;->b(I)Landroid/graphics/PorterDuff$Mode;
...
.method public declared-synchronized s(Landroid/content/Context;)V
    ...
    invoke-virtual {p1}, Landroidx/collection/e;->b()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized t(Landroid/content/Context;Landroidx/appcompat/widget/w0;I)Landroid/graphics/drawable/Drawable;
    .locals 1
...
.method x(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/e0$f;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
